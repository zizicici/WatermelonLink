...
const zhHans = pack({
  ...
  chooseTitle: "选择备份文件夹", chooseDetail: "网页只能访问你明确授权的文件夹。", choose: "选择", change: "更换", connectTitle: "创建安全连接", connectDetail: "请让两台设备连接同一 Wi-Fi；如果连接失败，请关闭 VPN。", connect: "创建", preparing: "正在创建安全连接…", waitingTitle: "使用 iPhone 扫描", waitingDetail: "使用系统相机，或在西瓜备份的「一次性 Link 节点」中扫描此二维码。", expires: "剩余", cancel: "取消", connectingTitle: "正在建立直连…", connectingDetail: "两台设备正在协商局域网 WebRTC 连接。", connectedTitle: "安全局域网连接已就绪", connectedDetail: "信令已经结束，两台设备现在直接连接。",
...
const zhHant = pack({
  ...
  chooseTitle: "選擇備份資料夾", chooseDetail: "網頁只能存取你明確授權的資料夾。", choose: "選擇", change: "更換", connectTitle: "建立安全連線", connectDetail: "請讓兩台裝置連接同一 Wi-Fi；如果連線失敗，請關閉 VPN。", connect: "建立", preparing: "正在建立安全連線…", waitingTitle: "使用 iPhone 掃描", waitingDetail: "使用系統相機，或在西瓜備份的「一次性 Link 節點」中掃描此 QR Code。", expires: "剩餘", cancel: "取消", connectingTitle: "正在建立直連…", connectingDetail: "兩台裝置正在協商區域網路 WebRTC 連線。", connectedTitle: "安全區域網路連線已就緒", connectedDetail: "信令已經結束，兩台裝置現在直接連線。",
...
const ko = pack({
  ...
  chooseTitle: "백업 폴더 선택", chooseDetail: "이 페이지는 사용자가 허용한 폴더에만 접근할 수 있습니다.", choose: "선택", change: "변경", connectTitle: "보안 링크 만들기", connectDetail: "두 기기를 같은 Wi-Fi에 연결하세요. 연결되지 않으면 VPN을 끄세요.", connect: "만들기", preparing: "보안 링크 준비 중…", waitingTitle: "iPhone으로 스캔", waitingDetail: "카메라 또는 수박 백업의 One-Time Link 노드에서 스캔하세요.", expires: "남은 시간", cancel: "취소", connectingTitle: "직접 연결 중…", connectingDetail: "두 기기가 로컬 WebRTC 연결을 협상하고 있습니다.", connectedTitle: "안전한 로컬 연결 준비 완료", connectedDetail: "시그널링이 종료되었으며 두 기기가 직접 연결되었습니다.",
